...
export { default as footerConnect } from './footerConnect.svg';
export { default as footerExplore } from './footerExplore.svg';
export { default as footerStart } from './footerStart.svg';
